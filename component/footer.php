  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="d-flex flex-column align-items-center justify-content-start text-center h-100 p-4">
          <a href="home.php" class="navbar-brand">
            <h1 class="m-0 text-white">
              <i class="fa me-2">
                <img src="./image/Logo-white.png" alt="Ajay Infotech Logo" style="margin-top: 5%;" width="200vw">
              </i><br>Ajay Infotech
            </h1>
          </a>
          <p class="mt-3 mb-4">
            Simple Solutions For Complex Problems<br>
            Want to Become Our Family Member? Join Us.
          </p>
        </div>
      </div>
      ...
      <div class="col-lg-8 col-md-6">
        <div class="row">
          <!-- Get in Touch -->
          <div class="col-lg-3 col-md-6 pt-5 mb-5 text-center text-md-start">
            <div class="section-title section-title-sm position-relative pb-3 mb-4">
              <h3 class="text-light mb-0">Get In Touch</h3>
            </div>
            <div class="link-animated d-flex flex-column align-items-center align-items-md-start">
    ...
    <!-- Copyright -->
    <div class="container-fluid text-white mt-4" style="background: #061429;">
      <div class="container text-center">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-6">
            <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
              <p class="mb-0">&copy; 2010-2025. <a class="text-white" href="#"><span style="color: #2bb1e0;">ajayinfotech.in</span></a> All Rights Reserved.</p>
            </div>
          </div>
        </div>
      </div>
