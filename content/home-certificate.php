    ...
    <div class="row">
       ...
       <div class="col-lg-6 col-sm-12 text-center">
            <img src="./image/certificate.png"
                class="img-fluid rounded shadow wow zoomIn box d-block mx-auto"
                data-wow-delay="0.9s"
                alt="Certificate">
        </div>
    </div>
</div>
<!-- home certificate section end here -->